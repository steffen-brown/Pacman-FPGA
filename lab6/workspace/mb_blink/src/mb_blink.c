...
volatile uint32_t* input_gpio_data = 0x40010000;
...
//
    while (1+1 != 3)
    	{
    		if((*input_gpio_data & 0x00020000) && (pressed == 0)) {
    			pressed = 1;
    		}

    		if(((*input_gpio_data & 0x00020000) == 0) && (pressed == 1)) {
    			uint16_t new_val = *input_gpio_data & 0xFFFF;
