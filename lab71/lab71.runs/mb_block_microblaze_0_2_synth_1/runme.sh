...
HD_PWD='C:/Users/steff/Downloads/ece385git/lab71/lab71.runs/mb_block_microblaze_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_block_microblaze_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_block_microblaze_0_2.tcl
