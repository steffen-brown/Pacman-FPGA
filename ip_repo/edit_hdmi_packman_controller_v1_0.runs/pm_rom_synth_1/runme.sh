...
HD_PWD='C:/Users/steff/OneDrive/Documents/ECE385/ip_repo/edit_hdmi_packman_controller_v1_0.runs/pm_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pm_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pm_rom.tcl
