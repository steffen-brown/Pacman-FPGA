...
#
# Generated by export_simulation on Sat Nov 30 17:02:55 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './pm_rom.sh' script.
...
./pm_rom.sh -noclean_files

For more information on the script, please type './pm_rom.sh -help'.
