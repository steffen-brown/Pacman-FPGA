...
#
# Generated by export_simulation on Sat Nov 30 10:07:30 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './ghosts_rom.sh' script.

./ghosts_rom.sh -reset_run
...
./ghosts_rom.sh -noclean_files

For more information on the script, please type './ghosts_rom.sh -help'.
