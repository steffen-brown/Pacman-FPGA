...
HD_PWD='C:/Users/steff/Downloads/ece385git/Lab 5/real_lab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testbench_5_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testbench_5_1.tcl
