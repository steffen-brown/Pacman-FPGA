...
HD_PWD='C:/Users/steff/OneDrive/Documents/ECE385/packman/packman.runs/mb_block_hdmi_packman_control_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_block_hdmi_packman_control_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_block_hdmi_packman_control_0_1.tcl
