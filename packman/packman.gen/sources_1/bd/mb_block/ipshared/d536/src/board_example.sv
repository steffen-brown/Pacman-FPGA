...
always_ff @ (posedge vga_clk) begin
    ...
    if (blank) begin
        ...
        else if (DrawX >= ghost0_x && DrawX < (ghost0_x + 26) && DrawY >= ghost0_y && DrawY < (ghost0_y + 26)) begin
            // Draw ghost0
            debug_ghost0 <= 1;
        ...
        else if (DrawX >= ghost1_x && DrawX < (ghost1_x + 26) && DrawY >= ghost1_y && DrawY < (ghost1_y + 26)) begin
            // Draw ghost1
            debug_ghost1 <= 1;
        ...
        else if (DrawX >= ghost2_x && DrawX < (ghost2_x + 26) && DrawY >= ghost2_y && DrawY < (ghost2_y + 26)) begin
            // Draw ghost2
            debug_ghost2 <= 1;
        ...
        else if (DrawX >= ghost3_x && DrawX < (ghost3_x + 26) && DrawY >= ghost3_y && DrawY < (ghost3_y + 26)) begin
            debug_ghost3 <= 1;
            // Draw ghost3
